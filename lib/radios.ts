...
const EDITORIAL_RADIOS: Radio[] = [
  { id: "fmlatina", name: "FM Latina", frequency: "89.1 FM", city: "Santiago", genre: "Pop latino", description: "La música que conecta a Chile, con clásicos y novedades en español.", streamUrl: "https://jm8n.com/proxy/radiofmlatina/stream", initials: "FL", accent: "#FF6B5F", featured: true, homepage: "https://www.radiofmlatina.com/", favicon: "https://www.radiofmlatina.com/wp-content/uploads/2020/06/LogoLatina1024x1024.png" },
  ...
  { id: "adn", name: "ADN Radio", frequency: "Cubre Chile", city: "Santiago", genre: "Noticias", description: "Noticias, análisis y conversación durante todo el día.", streamUrl: "https://playerservices.streamtheworld.com/api/livestream-redirect/ADNAAC.aac", initials: "ADN", accent: "#FF8C7F", homepage: "https://www.adnradio.cl/", favicon: "https://www.adnradio.cl/pf/resources/adn-radio/favicon.ico?d=91" },
  { id: "agricultura", name: "Radio Agricultura", frequency: "92.1 FM", city: "Santiago", genre: "Noticias", description: "Actualidad, opinión y conversación con sello chileno.", streamUrl: "https://unlimited4-us.dps.live/agricultura/gotardis/audio/now/livestream1.m3u8", initials: "AG", accent: "#76E0B5", homepage: "https://www.radioagricultura.cl/" },
  { id: "los40", name: "Los 40", frequency: "Cubre Chile", city: "Santiago", genre: "Música", description: "Los éxitos que marcan la música contemporánea.", streamUrl: "https://playerservices.streamtheworld.com/api/livestream-redirect/LOS40_CHILE_SC.mp3", initials: "40", accent: "#F2B6FF", homepage: "https://www.los40.cl/" },
  { id: "fmdos", name: "FM Dos", frequency: "98.5 FM", city: "Santiago", genre: "Música", description: "Música y compañía para todos los momentos del día.", streamUrl: "https://playerservices.streamtheworld.com/api/livestream-redirect/FMDOSAAC_SC.aac", initials: "F2", accent: "#FFD36A", homepage: "https://www.fmdos.cl/" },
  { id: "imagina", name: "Radio Imagina", frequency: "88.1 FM", city: "Santiago", genre: "Romántica", description: "Canciones inolvidables y compañía cercana.", streamUrl: "https://playerservices.streamtheworld.com/api/livestream-redirect/IMAGINA_SC.mp3", initials: "IM", accent: "#FF8C7F", homepage: "https://www.radioimagina.cl/", favicon: "https://www.radioimagina.cl/favicon.ico" },
