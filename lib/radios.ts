...
const EDITORIAL_RADIOS: Radio[] = [
  ...
  { id: "futuro", name: "Radio Futuro", frequency: "88.9 FM", city: "Santiago", genre: "Rock", description: "Rock, conversación y actualidad con identidad propia.", streamUrl: "https://playerservices.streamtheworld.com/api/livestream-redirect/FUTURO_SC.mp3", initials: "FU", accent: "#1ED760", homepage: "https://www.futuro.cl/", favicon: "https://www.futuro.cl/favicon.ico" },
