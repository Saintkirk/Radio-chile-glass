...
const EDITORIAL_RADIOS: Radio[] = [
  ...
  { id: "carolina", name: "Radio Carolina", frequency: "99.3 FM", city: "Santiago", genre: "Música", description: "Los éxitos y la energía que mueven a nuevas generaciones.", streamUrl: "https://stream.zeno.fm/sri2de2qdlivv", initials: "CA", accent: "#F2B6FF", featured: true, homepage: "https://www.carolina.cl/", favicon: "https://www.carolina.cl/_templatesB/desktop/includes/img/carolina.svg" },
