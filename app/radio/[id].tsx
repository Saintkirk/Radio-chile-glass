...
export default function RadioDetailScreen() {
  ...
  useEffect(() => {
    ...
    Animated.timing(stationTransition, { toValue: 1, duration: 260, easing: Easing.out(Easing.cubic), useNativeDriver: true }).start();
    return () => stationTransition.stopAnimation();
  }, [radio?.id, stationTransition]);
