...
export default function RadioDetailScreen() {
  ...
  const backgroundRadioId = useRef(id).current;
  const backgroundRadio = radios.find((item) => item.id === backgroundRadioId) ?? radio;
