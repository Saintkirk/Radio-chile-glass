...
export default function RadioDetailScreen() {
  ...
  // The detail screen is a view of the global player, not a second player.
  // Never freeze the background or carousel identity to the route's first id.
