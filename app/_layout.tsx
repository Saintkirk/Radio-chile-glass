...
import { APP_LOADER_EMERGENCY_FALLBACK_MS } from "@/lib/app-loader";
...
export default function RootLayout() {
  ...
  useEffect(() => {
    // A layout-level fallback protects startup even if AnimatedAppLoader or a
    // provider throws before its own completion callback can run.
    const emergencyTimer = setTimeout(() => setShowAppLoader(false), APP_LOADER_EMERGENCY_FALLBACK_MS + 250);
