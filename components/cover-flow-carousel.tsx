...
const styles = StyleSheet.create({
  root: { height: 340, borderRadius: 0, overflow: "hidden", backgroundColor: "#000000", borderWidth: 1, borderColor: "#171717", marginBottom: 28, paddingTop: 4 },
  rootLight: { backgroundColor: "#0A0A0A", borderColor: "#1A1A1A" },
  stage: { height: 246, alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden" },
  sideSlot: { position: "absolute", top: 22, width: 150, height: 214, zIndex: 1, alignItems: "center" },
  sideLeft: { left: -48 },
  sideRight: { right: -48 },
  centerSlot: { width: 210, height: 232, zIndex: 3, alignItems: "center" },
  ...
  sideCover: { width: 150, height: 190, borderRadius: 2 },
  centerCover: { width: 210, height: 210, borderRadius: 2, shadowRadius: 30, shadowOpacity: 0.78 },
  ...
  reflection: { position: "absolute", top: 194, width: 150, height: 62, opacity: 0.16, transform: [{ scaleY: -1 }], overflow: "hidden" },
  centerReflection: { width: 210, height: 72, opacity: 0.15, transform: [{ scaleY: -1 }], overflow: "hidden" },
